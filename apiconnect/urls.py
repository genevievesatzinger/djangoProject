...
urlpatterns = [
    ...
    path('login_admin/', login_logout.login_admin.as_view(), name='login_admin'),
    path('login_health_center/', login_logout.login_health_center.as_view(), name='login_health_center'),
    ...
    path('register_health_center/', register.register_health_center, name='register_health_center'),
    ...
    path('register_admin_user/', register.register_admin_user, name='register_admin_user'),
]